...
if MAIN:
    ...
    phiSmax_frac = float(sys.argv[11])
    phiRmax_frac = float(sys.argv[12])
    ...
    eval_out = f"{results_dir}_eval/{trial_name}_{eval_env}_{eval_variable}_phiS{phiSmax_frac}_phiR{phiRmax_frac}/{training_episode}/"
